...
- 'kiosk_interface.py', 'reservation_interface.py', 'admin_portal.py' (`Session`, `Schedule`, `Confirm`)
...
- 'machine_{id}' (`Machine`, `Confirm`)

**Publishes to**:  
- 'machine_{id}' (`Request`, `Machine`)  
- 'admin_portal.py' (`Machine`)  
- 'schedule_manager.py' (`Confirm`) (optional for full loop closure)
...
**Publishes to**:  
- 'machine_handler.py' (`Machine`, `Confirm`)
...
**Receives from**:  
- 'schedule_manager.py' (`Confirm`, `Session`, `Schedule`)
...
- `internal/session/kiosk/confirm`
- `internal/session/reservation/confirm`
- `internal/session/admin/confirm`
- `internal/session/request`
- `internal/session/kiosk`
- `internal/session/reservation`
- `internal/session/admin`

#### Schedule Topics
- `internal/schedule/request`
- `internal/schedule/kiosk`
- `internal/schedule/reservation`
- `internal/schedule/admin`

#### Machine Topics (Internal)
- `internal/machine/handler`
- `internal/machine/request`
- `internal/machine/report`

#### Machine Topics (External)
- `external/machine/{id}/request`
- `external/machine/{id}/report`
- `external/machine/{id}`
- `external/machine/{id}/confirm`

### Session Topics

#### Kiosk, Portal, Reservation → Schedule Manager (Session Ingress)

- **MQTT Topic**: `internal/session/manager`
- **Model Used**: `Session`
...
- **MQTT Topic**: `internal/session/kiosk/confirm`, `internal/session/reservation/confirm`, `internal/session/admin/confirm`
- **Model Used**: `Confirm`
...
- **MQTT Topic**: `internal/session/request`
- **Model Used**: `Request`
...
- **MQTT Topic**: `internal/session/kiosk`, `internal/session/reservation`, `internal/session/admin`
- **Model Used**: `Session`
...
- **MQTT Topic**: `internal/schedule/request`
- **Model Used**: `Request`
...
- **MQTT Topic**: `internal/schedule/kiosk`, `internal/schedule/reservation`, `internal/schedule/admin`
- **Model Used**: `Schedule`
...
- **MQTT Topic**: `internal/machine/handler`
- **Model Used**: `Machine`
...
- **MQTT Topic**: `internal/machine/request`
- **Model Used**: `Request`
...
- **MQTT Topic**: `internal/machine/report`
- **Model Used**: `Machine`
...
- **MQTT Topic**: `external/machine/{id}/request`
- **Model Used**: `Request`
- **Purpose**: Requests that the machine send its information about ball level, status, end of scheduled time, etc to the machine handler
- **Origin Node**: 'machine_handler.py'
- **Destination Node**: machine_{id}
...
- **MQTT Topic**: `external/machine/{id}/report`
- **Model Used**: `Machine`
...
- **MQTT Topic**: `external/machine/{id}/confirm`
- **Model Used**: `Confirm`
- **Purpose**: Confirms that status changes to the machine were received and accepted or rejected
- **Origin Node**: 'machine_{id}'
- **Destination Node**: 'machine_handler.py'
